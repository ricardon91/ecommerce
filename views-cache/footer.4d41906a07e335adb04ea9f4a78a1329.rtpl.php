...
<!-- jQuery sticky menu -->
<script src="../resourses/site/js/owl.carousel.min.js"></script>
<script src="../resourses/site/js/jquery.sticky.js"></script>

<!-- jQuery easing -->
<script src="../resourses/site/js/jquery.easing.1.3.min.js"></script>

<!-- Main Script -->
<script src="../resourses/site/js/main.js"></script>

<!-- Slider -->
<script type="text/javascript" src="../resourses/site/js/bxslider.min.js"></script>
<script type="text/javascript" src="../resourses/site/js/script.slider.js"></script>
</body>
</html>
